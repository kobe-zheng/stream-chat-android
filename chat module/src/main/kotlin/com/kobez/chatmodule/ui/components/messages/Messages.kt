...
import com.kobez.chatmodule.state.MyOwn
import com.kobez.chatmodule.ui.components.LoadingIndicator
import com.kobez.chatmodule.ui.components.MessagesScrollingOption
...
internal fun BoxScope.DefaultMessagesHelperContent(
    ...
    val focusedItemIndex = messages.indexOfFirst { it is MessageItemState }
    ...
    if (isScrollToBottomButtonVisible(firstVisibleItemIndex.value, areNewestMessagesLoaded)) {
...
private fun isScrollToBottomButtonVisible(
    ...
    return isScrollToBottomButtonVisibleInMessageList(firstVisibleItemIndex, areNewestMessagesLoaded)
}
